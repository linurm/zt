...
package com.others.zxing.integration.android;
...
public class IntentIntegrator {
	...
	private static final String BS_PACKAGE = "zj.zfenlly.tools";
	...
	protected void startActivityForResult(Intent intent, int code) {
		if (fragment == null) {
			//Log.e("", code + intent.toString());
			activity.startActivityForResult(intent, code);
		} else {
			//Log.e("fragment", code + intent.toString());
	...
	private String findTargetAppPackage(Intent intent) {
		...
		// Log.e(TAG, availableApps.toString());
		...
		if (requestCode == REQUEST_CODE) {
			if (resultCode == Activity.RESULT_OK) {
				...
				int intentOrientation = intent.getIntExtra(
						Intents.Scan.RESULT_ORIENTATION, Integer.MIN_VALUE);
				Integer orientation = intentOrientation == Integer.MIN_VALUE ? null
						: intentOrientation;
				String errorCorrectionLevel = intent
						.getStringExtra(Intents.Scan.RESULT_ERROR_CORRECTION_LEVEL);
