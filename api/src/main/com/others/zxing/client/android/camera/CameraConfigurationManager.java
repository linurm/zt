...
import com.others.zxing.client.android.camera.open.CameraFacing;
...
public final class CameraConfigurationManager {
	...
	void initFromCameraParameters(OpenCamera camera) {
		...
		// Camera at: 90
		// Still not 100% sure aCamera at: 90bout this. But acts like we need to
		// flip this:
		...
		// Log.e(TAG, "Final display orientation: "
		...
		// Log.e(TAG, "Screen resolution in current orientation: "
		// + screenResolution);
	...
	void setDesiredCameraParameters(OpenCamera camera, boolean safeMode) {
		...
		// parameters.setRotation(cwNeededRotation);
		// parameters.set("orientation", "portrait");
		// Log.e(TAG, "setRotation: " + cwNeededRotation);
		...
		// Log.e(TAG, "setDisplayOrientation " + cwRotationFromDisplayToCamera);
