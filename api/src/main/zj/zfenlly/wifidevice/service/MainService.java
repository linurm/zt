package zj.zfenlly.wifidevice.service;
...
import zj.zfenlly.wifidevice.util.ByteAndInt;
import zj.zfenlly.wifidevice.util.Constant;
import zj.zfenlly.wifidevice.util.FileName;
import zj.zfenlly.wifidevice.util.FileState;
import zj.zfenlly.wifidevice.util.Message;
...
//        Log.e("TAG", "onStart CheckNet Start");
    ...
    private class ServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Constant.WIFIACTION) || intent.getAction().equals(Constant.ETHACTION)) {
                ...
                Log.e("TAG", "onReceive CheckNet Start");
...
//            audioHandler.start();
        ...
        private void parsePackage(byte[] pkg) {
            ...
            Log.e("TAG", "CMD: " + CMD + " type: " + cmdType);
            switch (CMD) {
                case Constant.CMD80:
                    switch (cmdType) {
