...
//    }
    ...
    public List<StockData> getStockInfoDB(String stockCodes) throws HttpException,
        ...
        List<StockData> list = parseStockDataFromReader(bReader);
        bReader.close();
        method.releaseConnection();
    ...
    private List<StockData> parseStockDataFromReader(BufferedReader reader)
            throws IOException, Stock2Info.ParseStockInfoException {

        ArrayList<StockData> list = new ArrayList<StockData>(1);
